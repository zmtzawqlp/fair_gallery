...
Map<String, String> _fixes = <String, String>{
  ...
  '''  'Gradient.linear': (props) => Gradient.linear(
        ...
        props['pa'][1],
        props['pa'][2],
        as<double>((props['pa'].length > 3 ? props['pa'][3] : null)),
        (props['pa'].length > 4 ? props['pa'][4] : null) ?? TileMode.clamp,
        (props['pa'].length > 5 ? props['pa'][5] : null),
      ),
  'Gradient.radial': (props) => Gradient.radial(
        ...
        (props['pa'].length > 4 ? props['pa'][4] : null) ?? TileMode.clamp,
        (props['pa'].length > 5 ? props['pa'][5] : null),
        (props['pa'].length > 6 ? props['pa'][6] : null),
        (props['pa'].length > 7 ? props['pa'][7] : null)?.toDouble() ?? 0.0,
      ),
  'Gradient.sweep': (props) => Gradient.sweep(
        props['pa'][0],
        props['pa'][1],
        as<double>((props['pa'].length > 2 ? props['pa'][2] : null)),
        (props['pa'].length > 3 ? props['pa'][3] : null) ?? TileMode.clamp,
        (props['pa'].length > 4 ? props['pa'][4] : null)?.toDouble() ?? 0.0,
        (props['pa'].length > 5 ? props['pa'][5] : null)?.toDouble() ??
            math.pi * 2,
        (props['pa'].length > 6 ? props['pa'][6] : null),
      ),''': '',
